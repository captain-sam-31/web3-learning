...
// svg文件要包一层函数，才能作为react组件使用
const MetamaskIcon = (props: HTMLProps<SVGSVGElement>) => (
  <svg {...props} xmlns="http://www.w3.org/2000/svg" width="212" height="189" viewBox="0 0 212 189" id="metamask">
